...
**This test was copied from [Creditas tests repository](https://github.com/Creditas/challenge). If you already did this test for Creditas there's no need to do it again, just open a pull request to us also.**
